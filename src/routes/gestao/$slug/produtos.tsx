...
// Evento não entra: tem tabela e tela próprias (Agenda).
      ...
      <form onSubmit={handleSubmit(submit)} className="mt-6 grid gap-8">
        ...
        <section className="grid gap-5">
          ...
          {/* Era um checkbox "feito sob encomenda" com três frases de explicação dentro do
              ...
              a pessoa escolhe entre dois mundos que ela reconhece. */}
          ...
          {!onDemand && (
            <Field
              label="Quantos você tem agora?"
              htmlFor="stock"
              hint="Chegando a zero o produto aparece como esgotado e quem quiser entra na fila. Volta a vender sozinho quando você repõe."
